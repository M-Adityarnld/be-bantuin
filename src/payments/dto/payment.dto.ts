...
export const InitiatePaymentSchema = z.object({
  orderId: z.string().uuid({ message: 'Order ID tidak valid' }),
...
export const WithdrawRequestSchema = z.object({
  amount: z
    ...
    .max(10000000, {
      message: 'Maksimal withdraw adalah Rp 10.000.000 per transaksi',
    }),
...
export const TopUpWalletSchema = z.object({
  amount: z
    ...
    .max(5000000, {
      message: 'Maksimal top up adalah Rp 5.000.000 per transaksi',
    }),

  paymentMethod: z
    .enum(['bank_transfer', 'gopay', 'shopeepay', 'qris'])
